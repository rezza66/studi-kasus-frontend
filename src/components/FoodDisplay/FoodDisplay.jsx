...
import { fetchFoodList, selectFoodList, selectFoodStatus, selectFoodError, selectPage, selectTotalPages, setPage, selectLimit } from '../../redux/slices/productsSlice';
...
const FoodDisplay = () => {
  ...
  useEffect(() => {
    dispatch(fetchFoodList({ page: currentPage, limit }));
